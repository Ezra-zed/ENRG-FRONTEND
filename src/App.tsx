  ...
  return (
    <Link href="/" data-testid="link-logo" className="group flex items-center gap-2.5">
      <span className="enrg-logo-mark">
        <img src="/favicon.svg?v=2" alt="ENRG company logo" />
      </span>
  ...
  return (
    <AuthLayout eyebrow="For homeowners" title="Put your home in the sun.">
      ...
      <form onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
        <Field required label="Full name" placeholder="Your name" value={form.name} onChange={update('name')} data-testid="input-register-name" />
        <Field required label="Mobile number" placeholder="98765 43210" value={form.mobile} onChange={update('mobile')} data-testid="input-register-mobile" />
...
function AuthLayout({ eyebrow, title, children }: { eyebrow: string; title: string; children: React.ReactNode }) {
  return (
    <div className="grid min-h-[calc(100dvh-72px)] lg:grid-cols-[.85fr_1.15fr]">
...
function Signup() {
  ...
  return (
    <AuthLayout eyebrow="Join the network" title="Your next chapter runs on sunlight.">
      ...
      <form onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
        <Field required label="Full name" placeholder="Your name" value={form.name} onChange={update('name')} data-testid="input-signup-name" />
        <Field required type="email" label="Email address" placeholder="you@example.com" value={form.email} onChange={update('email')} data-testid="input-signup-email" />
        <Field required label="Phone number" placeholder="98765 43210" value={form.phone} onChange={update('phone')} data-testid="input-signup-phone" />
        <Field required type="password" label="Password" placeholder="At least 6 characters" value={form.password} onChange={update('password')} data-testid="input-signup-password" />
        {role !== 'user' && (
          <>
            <div className="sm:col-span-2">
      ...
      <section className="signin-modal" aria-label="Sign in to ENRG">
        ...
        <div className="signin-modal-brand">
          <span className="signin-modal-mark">
            <img src="/favicon.svg" alt="ENRG company logo" />
          </span>
          <div>
        ...
        {method !== 'O-auth' && (
          <form onSubmit={submit} className="grid gap-4">
            ...
            {method === 'no-password' && (
              <>
                <Field required autoComplete="tel" label="Mobile number" placeholder="98765 43210" value={form.phone} onChange={update('phone')} data-testid="input-signin-phone" />
...
function CompanyLeads() {
  ...
  return (
    <CompanyShell>
      ...
      {active && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-[#183d34]/35 p-5 backdrop-blur-sm">
          <form onSubmit={submitQuote} className="w-full max-w-md rounded-3xl border border-border bg-card p-6 shadow-2xl">
